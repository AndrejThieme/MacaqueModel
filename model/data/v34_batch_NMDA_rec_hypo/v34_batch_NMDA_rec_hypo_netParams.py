...
netParams.synMechParams['GABAA'] = {'mod':'MyExp2SynBB', 'tau1': 0.07, 'tau2': 18.2, 'e': -80} #previously tau2=18.2
...
# HERE FACTOR FOR MODIFICATIOSN OF PV CELL WEIGHTS --> SEE SIMILAR EXAMPLES FOR OTHER PARAMETERS
# ALSO I -> I
# I = Inhibitory, E = Exhibitory
                    ...
                    for post in Epops:
                        for l in layerGainLabels:  # used to tune each layer group independently
                            ...
                            netParams.connParams['IE_'+pre+'_'+preType+'_'+post+'_'+l] = { 
                                ...
                                'synMech': synMech,
                                'probability': prob,
                                'weight': wmat[pre][post] * pv_red_factor * soma_red_factor * cfg.IEGain * cfg.IECellTypeGain[preType] * cfg.IELayerGain[l], 
            ...
            for post in Ipops:
                for l in layerGainLabels: 
                    ...
                    netParams.connParams['II_'+pre+'_'+post+'_'+l] = { 
                        ...
                        'synMech': synMech,
                        'probability': prob,
                        'weight': wmat[pre][post] * pv_red_factor * soma_red_factor * cfg.IIGain * cfg.IILayerGain[l], 
